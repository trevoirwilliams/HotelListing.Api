...
//        var cacheKey = $"{CacheConstants.CountryListCacheName}{searchTerm}";
...
//    {
//        // Check the cache
//        var cacheKey = $"{CacheConstants.CountrySingleCacheName}{id}";
//        if (!cache.TryGetValue(cacheKey, out GetCountryDto? country)) 
//        {
//            // if not found in the cache, then hit the database
...
//            cache.Remove($"{CacheConstants.CountryListCacheName}");
...
//    {
//        cache.Remove($"{CacheConstants.CountrySingleCacheName}{id}");
//    }
